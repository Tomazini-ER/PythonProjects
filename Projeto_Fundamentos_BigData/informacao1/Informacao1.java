...
public class Informacao1 {
        ...
        public void map(Object chave, Text valor, Context context) throws IOException, InterruptedException {
            try {
                ...
                if (campo.length == 10) {
                    ...
                    Text chaveCampo = new Text(campo[0]);
    ...
    public static void main(String[] args) throws IOException, InterruptedException, ClassNotFoundException {
        ...
        String saida = "/home2/ead2021/SEM1/estevan.rafael/Desktop/atp/" + Informacao1.class.getSimpleName();
        //String saida = "/home2/ead2021/SEM1/estevan.rafael/Desktop/atp/" + Informacao1.class.getSimpleName();
        ...
        Job job = Job.getInstance(config, Informacao1.class.getSimpleName());
