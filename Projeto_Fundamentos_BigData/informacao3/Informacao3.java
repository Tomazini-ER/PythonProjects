...
// 3 transacoes comerciais por ano - Maior negociação com o BR
//Indice
//0 país
//1 ano
//2 codigo
...
public class Informacao3 {
        ...
        public void map(Object chave, Text valor, Context context) throws IOException, InterruptedException {
            try {
                ...
                if (campo.length == 10) {
                    ...
                    Text chaveCampo = new Text(campo[1]);
    ...
    public static void main(String[] args) throws IOException, InterruptedException, ClassNotFoundException {
        ...
        String saida = "/home2/ead2021/SEM1/estevan.rafael/Desktop/atp/" + Informacao3.class.getSimpleName();
        //String saida = "/home2/ead2021/SEM1/estevan.rafael/Desktop/atp/" + Informacao3.class.getSimpleName();
        ...
        Job job = Job.getInstance(config, Informacao3.class.getSimpleName());
